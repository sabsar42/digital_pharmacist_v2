    ...
    return AlertDialog(
      ...
      content: Column(
        ...
        children: [
          ...
          Text('${widget.beforeAfterMeal} ',style: size15Black(),),
          Text('Pill Limit  ${widget.pillLimit}X',style: size15Black(),),
          Text('Duration ${widget.medDuration} Days',style: size15Black(),),
          Text('Remaining ${widget.remainingDays} days',style: size15Black(),),
          Text('Medicine-Form : ${widget.medType}',style: size15Black(),),
        ],
      ),
      actions: [
        Row(
